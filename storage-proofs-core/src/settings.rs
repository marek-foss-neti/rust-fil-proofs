...
pub struct Settings {
    ...
    pub use_zigzag_parent_cache: bool,
    pub zigzag_parent_cache_size: u32,
    pub zigzag_multicore_encode: bool,
    pub zigzag_multicore_encode_producers: usize,
    pub zigzag_multicore_encode_producer_stride: usize,
    pub zigzag_multicore_encode_lookahead: usize,
...
impl Default for Settings {
    fn default() -> Self {
        Settings {
            ...
            use_zigzag_parent_cache: true,
            zigzag_parent_cache_size: 2_048,
            zigzag_multicore_encode: true,
            zigzag_multicore_encode_producers: 2,
            zigzag_multicore_encode_producer_stride: 128,
            zigzag_multicore_encode_lookahead: 4096,
